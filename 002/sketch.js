function setup() { 
  ...
  fill(219, 199, 170);
  var y1 = 47;
  for (var x1 = 152; x1 < 420; x1 = x1 + 30) {
    triangle(x1, y1, x1 + 15, y1 - 10, x1 + 30, y1);
  }
  ...
  fill(66, 62, 105, 200);
  var y2 = 67;
  for (var x2 = 152; x2 < 420; x2 = x2 + 30) {
    quad(x2, y2, x2 + 15, y2 - 10, x2 + 30, y2, x2 + 15, y2 + 10);
  }
  ...
  stroke(34, 23, 33);
  var y3 = 95;
  for (var x3 = 152; x3 < 420; x3 = x3 + 5) {
    line(x3, y3, x3 + 6, y3 - 6);
  }
  //X rojas

  stroke(143, 50, 48);
  var y4 = 116;
  for (var x4 = 150; x4 < 420; x4 = x4 + 10) {
    line(x4, y4, x + 8, y4 - 8);
  }
  var y5=116;
  for (var x5 = 157; x5 < 420; x5 = x5 + 10) {
    line(x5 - 8, y5 - 8, x5, y5);
  }
